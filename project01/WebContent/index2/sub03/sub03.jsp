		...
		<div id="contents">
			...
			<h2 class="hidden">이용안내</h2>
				<ul>
					...
					<li class="menu2"><a href="/project01/index2/sub04/sub04.jsp"><span class="Text">도서관소식</span><span class="Img"><img src="images/lnb_minus_off.png" alt="minusImg"/></span></a></li>
