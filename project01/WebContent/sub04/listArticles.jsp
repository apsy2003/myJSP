	...
	<script>
		function loginCheck(){
			if(<%= userId %> == null){
				...
				location.href = "${contextPath}/index2/sub04/articleForm.jsp";
			}
		}
	</script>
	...
	<div class="contents">
		<div class="Menubar fl">
			...
			<ul>
				...
				<li class="menu2"><a href="/project01/sub02/login02.jsp"><span class="Text">도서관이용안내</span><span class="PImg"><img src="/project01/sub04/images/lnb_plus_off.png" alt="PlusImg"/></span></a></li>
				<li class="menu2"><a href="/project01/sub02/login01.jsp"><span class="Text">상호대차</span><span class="IImg"><img src="/project01/sub04/images/lnb_minus_off.png" alt="minusImg"/></span></a></li>
				<li class="menu2"><a href="/project01/sub04/sub04.jsp"><span class="Text">모바일앱</span><span class="Img"><img src="/project01/sub04/images/lnb_minus_off.png" alt="minusImg"/></span></a></li>
				<li class="menu2"><a href="/project01/board/listArticles.do"><span class="Text">스마트도서관</span><span class="Img"><img src="/project01/sub04/images/lnb_minus_off.png" alt="minusImg"/></span></a></li>
				<li class="menu2"><a href="/project01/index.jsp"><span class="Text">책배달서비스</span><span class="PImg"><img src="/project01/sub04/images/lnb_plus_off.png" alt="plusImg"/></span></a></li>
				<li class="menu2"><a href="/project01/sub03/sub03.jsp"><span class="Text">전자도서관</span><span class="PPImg"><img src="/project01/sub04/images/lnb_plus_off.png" alt="plusImg"/></span></a></li>
			</ul>
		</div>
...
<!-- <div class="page_Wrap"> --> 
	...
	<div class="postWrap">
			<input type="button" class="post fr" onClick="loginCheck()" value="글쓰기" />
	</div> 
</div>	
	<!-- </div> -->
</section>
