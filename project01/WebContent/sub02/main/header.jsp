...
<header>
	...
	<fmt:bundle basename="resource.member">
		<div id="header" class="cf">
			<div id="gnb">
				<div class="gnbWrap">
					...
					<div class="gnb2 fr">
						...
						<ul class="gtrans fl">
							<li class="gfirst fl"><a href="/project01/sub02/login01.jsp?lo=ko"><fmt:message key="menu.nav47" /></a></li>
							<li class="fl"><a href="/project01/sub02/login01.jsp?lo=en"><fmt:message key="menu.nav48" /></a></li>
						</ul>
						<div class="gsns fl">
			...
			<nav class="nav1 cf">
				<div class="sub1Wrap">
					<h1 class="logo fl"><a href="/project01/index.jsp" tabindex="8"><img src="${contextPath}/main/images/logo.png" alt="로고"/></a></h1>
					<ul class="sub1 cf">
