...
<meta charset="UTF-8">
	...
	<fmt:bundle basename="resource.member">
		<div id="header" class="cf">
			<div id="gnb">
				<div class="gnbWrap">
					...
					<div class="gnb2 fr">
						...
						<ul class="gtrans fl">
							<li class="gfirst fl"><a href="/project01/sub03/sub03.jsp?lo=ko"><fmt:message key="menu.nav47" /></a></li>
							<li class="fl"><a href="/project01/sub03/sub03.jsp?lo=en"><fmt:message key="menu.nav48" /></a></li>
						</ul>
						<div class="gsns fl">
							<a href="https://pf.kakao.com/_MxfxkLT" tabindex="4"><img src="/project01/sub03/images/top_snsKakao.png" alt="카카오"/></a>
							<a href="https://www.instagram.com/anyanglib/" tabindex="5"><img src="/project01/sub03/images/top_snsInsta.png" alt="인스타"/></a>
							<a href="https://twitter.com/anyanglib" tabindex="6"><img src="/project01/sub03/images/top_snsTwitter.png" alt="트위터"/></a>
							<a href="https://www.youtube.com/channel/UCOTyiNx6Di5A_Yn4SrzNMzg" tabindex="7"><img src="/project01/sub03/images/top_snsYoutube.png" alt="유튜브"/></a>
						</div>
					</div>
				</div>
			</div>
			<nav class="nav1 cf">
				<div class="sub1Wrap">
					<h1 class="logo fl"><a href="/project01/index.jsp" tabindex="8"><img src="/project01/sub03/images/logo.png" alt="로고"/></a></h1>
					<ul class="sub1 cf">
						...
						<li class="searchbtn fl"><a href="#" tabindex="54"><img src="/project01/sub03/images/btn_search.png" width="30" height="30" alt="돋보기"/></a></li>
					</ul>
				</div>		
			</nav>
			<nav class="nav2 cf">
