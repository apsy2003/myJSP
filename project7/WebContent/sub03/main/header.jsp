			...
			<div id="gnb">
				<div class="gnbWrap">
					...
					<div class="gnb2 fr">
						...
						<ul class="gtrans fl">
							<li class="gfirst fl"><a href="sub03.jsp?lo=ko"><fmt:message key="menu.nav47" /></a></li>
							<li class="fl"><a href="sub03.jsp?lo=en"><fmt:message key="menu.nav48" /></a></li>
						</ul>
						<div class="gsns fl">
			...
			<nav class="nav1 cf">
				<div class="sub1Wrap">
					...
					<ul class="sub1 cf">
						...
						<li class="sub1_1 fl"><a href="sub03.jsp" tabindex="9"><fmt:message key="menu.nav3" /></a></li>
			...
			<nav class="nav2 cf">
				<div class="sub2Wrap">
					<div class="sub2Inner">
						...
						<div class="sub2">
							<ul class="sub2_1 fl">
								<li class="sub2_2"><a href="sub03.jsp" tabindex="23"><fmt:message key="menu.nav18" /></a></li>
								<li class="sub2_2"><a href="sub03.jsp" tabindex="24"><fmt:message key="menu.nav19" /></a></li>
								<li class="sub2_2"><a href="sub03.jsp" tabindex="25"><fmt:message key="menu.nav20" /></a></li>
								<li class="sub2_2"><a href="sub03.jsp" tabindex="26"><fmt:message key="menu.nav21" /></a></li>
								<li class="sub2_2"><a href="sub03.jsp" tabindex="27"><fmt:message key="menu.nav22" /></a></li>
								<li class="sub2_2"><a href="sub03.jsp" tabindex="28"><fmt:message key="menu.nav23" /></a></li>
								<li class="sub2_2"><a href="sub03.jsp" tabindex="29"><fmt:message key="menu.nav24" /></a></li>
							</ul>
						</div>
						<div class="sub2">
							<ul class="sub2_1 fl">
