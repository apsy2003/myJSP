function unit(x){
		...
		function ddaycount(){
			imgArr = ['index/images/pop/num0.png','index/images/pop/num1.png','index/images/pop/num2.png','index/images/pop/num3.png','index/images/pop/num4.png','index/images/pop/num5.png','index/images/pop/num6.png','index/images/pop/num7.png',
			'index/images/pop/num8.png','index/images/pop/num9.png'];
