		...
		<div id="header" class="cf">
			<div id="gnb">
				<div class="gnbWrap">
					...
					<div class="gnb2 fr">
						<div class="admin fl">
							<p class="userName"><span class="impectUser"><img src="/project01/index2/images/newUser.png" alt=""/></span><strong>관리자(admin)</strong>님</p>
							<input type="submit" onClick="fn_sendMember()" id="loginbutton" title="회원관리" value="회원관리" class="Aministration"/>
			...
			<nav class="nav1 cf">
				<div class="sub1Wrap">
					<h1 class="logo fl"><a href="/project01/index/index2.jsp" tabindex="8"><img src="/project01/index2/images/logo.png" alt="로고"/></a></h1>
					<ul class="sub1 cf">
