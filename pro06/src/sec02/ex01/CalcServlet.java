...
public class CalcServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//toString(); 메서드를 재정의하는 불편함을 없애기 위해서 쓴다.
		...
		// 반환할 외화 종류를 받아온다.
		String operator = request.getParameter("operator"); // operator = 금액 명칭(달러/파운드/엔화 등)
		// 실행하기 위해선 세가지의 String이 필요.
	...
	//계산하는 함수를 클래스로 만듬. 파라매트를 집어넣으면, 결과를 도출해준다.
